...
2. The test file should be located at the same place in the test project. 
   For example if have file located in **Nitrocoin.Bitcoin\BlockStore\BlockRepository.cs** 
   it should be **Nitrocoin.Bitcoin.Test\BlockStore\BlockRepositoryTest.cs** in the test project.
