...
namespace Nitrocoin.Bitcoin.Tests.Logging
{
	public class LogsTestBase
	{
		...
		public LogsTestBase()
		{
			...
			loggerFactory.Setup(l => l.CreateLogger("Nitrocoin.Bitcoin.FullNode"))
			   .Returns(fullNodeLogger.Object)
			   .Verifiable();
			loggerFactory.Setup(l => l.CreateLogger("Nitrocoin.Bitcoin.RPC"))
