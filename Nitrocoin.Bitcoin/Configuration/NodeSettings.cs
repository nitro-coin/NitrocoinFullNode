...
namespace Nitrocoin.Bitcoin.Configuration
{
	public class NodeSettings
	{
			...
			ProtocolVersion protocolVersion = SupportedProtocolVersion)
		{
			...
			{
				nodeSettings.DataDir = GetDefaultDataDir($"Nitrocoin{nodeSettings.Name}", nodeSettings.Network);
			}
		...
		{			
			...
			{				
				...
				builder.AppendLine(" dotnet exec <Nitrocoin.NitrocoinD/BitcoinD.dll> [arguments]");
				builder.AppendLine();
